...
public class Inv3st_Plan_source {
    public static final int MAX_HOURS = 12;
    private static Object currency = new String();
    private String _out;
    private static List<String> allowingPrfts1;

    private Inv3st_Plan_source(String output) {
        this._out = output;
    }

    public static Inv3st_Plan_source input(String input) {
        ...
        synchronized (allowingPrfts1) {
            ...
            return new Inv3st_Plan_source(output1.toString());
        }
    }
